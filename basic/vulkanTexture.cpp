 ...
 *
 * [introduction]
 * Implementions of Vulkan texture class
 */
...
namespace vks
{
    ...
    /// @brief Load a 2D texture including all mip levels
    /// @param filename File to load (supports .ktx)
    /// @param format Vulkan format of the image data stored in the file
    /// @param device Vulkan device to create the texture on
    /// @param copyQueue Queue used for the texture staging copy commands (must support transfer)
    /// @param imageUsageFlags (Optional) imageUsageFlags Usage flags for the texture's image (defaults to VK_IMAGE_USAGE_SAMPLED_BIT)
    /// @param imageLayout (Optional) imageLayout Usage layout for the texture (defaults VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL)
    /// @param forceLinear (Optional) forceLinear Force linear tiling (not advised, defaults to false)
    ...
    /// @param device Vulkan device to create the texture on
    /// @param copyQueue Queue used for the texture staging copy commands (must support transfer)
    /// @param filter (Optional) filter Texture filtering for the sampler (defaults to VK_FILTER_LINEAR)
    /// @param imageUsageFlags (Optional) imageUsageFlags Usage flags for the texture's image (defaults to VK_IMAGE_USAGE_SAMPLED_BIT)
    /// @param imageLayout (Optional) imageLayout Usage layout for the texture (defaults VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL)
                               ...
                               VkImageLayout imageLayout)
    {
        ...
        // Create a host-visible staging buffer that cotains the raw iamge data
        VkBuffer stagingBuffer;
        VkDeviceMemory stagingMemory;
    ...
    /// @brief Load a 2D texture array including all mip levels
    /// @param filename  File to load (supports .ktx)
    /// @param format Vulkan format of the image data stored in the file
    /// @param device Vulkan device to create the texture on
    /// @param copyQueue Queue used for the texture staging copy commands (must support transfer)
                                      ...
                                      VkImageLayout imageLayout)
    {
        ...
        this->width = ktxTexture->baseWidth;
        this->height = ktxTexture->baseHeight;
        this->layerCount = ktxTexture->numLayers;
        this->mipLevels = ktxTexture->numLevels;
        ...
        // For each layer and miplevel to create a iamgeCopy
    ...
    /// @brief Load a cubemap texture including all mip levels from a single file
    /// @param filename File to load (supports .ktx)
    /// @param format Vulkan format of the image data stored in the file
    /// @param device Vulkan device to create the texture on
    /// @param copyQueue Queue used for the texture staging copy commands (must support transfer)
